...
export default function About({ data }: AboutProps) {
  return (
    ...
    >
      {/* Decorative blobs */}
      <div className="absolute top-0 right-0 w-72 h-72 bg-blue-50 rounded-full -translate-y-1/2 translate-x-1/3 blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-60 h-60 bg-blue-50 rounded-full translate-y-1/2 -translate-x-1/3 blur-3xl pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            >
              <div className="bg-linear-to-br from-blue-50 to-slate-100 rounded-2xl p-6 border border-blue-100">
              ...
              <div className="bg-linear-to-br from-slate-50 to-slate-100 rounded-2xl p-6 border border-slate-200">
                <div className="w-10 h-10 rounded-xl bg-blue-600/10 flex items-center justify-center mb-2">
